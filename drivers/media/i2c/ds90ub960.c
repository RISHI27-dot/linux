...
static const struct ub960_format_info ub960_formats[] = {
	...
	{ .code = MEDIA_BUS_FMT_RAW_10, .bpp = 10, .datatype = MIPI_CSI2_DT_RAW10, },
	{ .code = MEDIA_BUS_FMT_META_10, .bpp = 10, .datatype = MIPI_CSI2_DT_RAW10, },
	...
	{ .code	= MEDIA_BUS_FMT_RAW_8, 	.bpp = 8, .datatype = MIPI_CSI2_DT_RAW8, },
	{ .code	= MEDIA_BUS_FMT_META_8, .bpp = 8, .datatype = MIPI_CSI2_DT_EMBEDDED_8B, },
...
static int ub960_init_rx_ports_ub960(struct ub960_data *priv)
{
	...
	ret = ub960_update_bits(priv, UB960_SR_RX_PORT_CTL, enabled_rxports_mask, enabled_rxports, &ret);
	if (ret)
		return ret;
					       ...
					       struct v4l2_subdev_state *state)
{
	...
	ret = ub960_update_bits(priv, UB960_SR_FWD_CTL1, priv->rx_mask, fwd_ctl, &ret);
